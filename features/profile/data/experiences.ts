...
- Collaborated with team members to deliver secure, efficient, and user-friendly solutions.`,
        skills: ["Next.js", "React", "Node.js", "React Native", "RESTful APIs"],
      },
    ],
    ...
    positions: [
      {
        ...
        icon: "code",
        description: `- Built the fronted of a  location-based freelancing platform using the MERN stack to connect local workers with nearby jobs.
- Add the feature of native language to support the local workers, boosting user engagement by 20% under tight deadlines.`,
        skills: ["React", "Redux", "Tailwind", "Node.js", "API Development"],
      },
      {
        id: "ssip_2023",
        title: "SSIP - 2023",
        ...
        icon: "code",
        description: `- Developed the fronted for an  AI-driven chatbot for GMSCL using the MERN stack to streamline access to medical equipment data and meeting bookings.
- Handle the real time message update in fronted and status update  to reduce information retrieval time by 30%, a React-based interface improved navigation and boosted user satisfaction by 25%.`,
        skills: [
          "AI",
          "Chatbot",
          "MERN Stack",
...
- Covered data preprocessing, model training, and evaluation through hands-on exercises.`,
      ...
      },
      {
        ...
        icon: "education",
        description:
          "Certified in React.js development, demonstrating proficiency in component-based architecture, responsive UI design, and modern frontend practices.",
